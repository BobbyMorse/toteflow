...
export async function GET() {
  ...
  const header = [
    ...
    "stagedEV","capturedTrueP","potentialPayout","postTime","status","mode","shadow","shadowStake","shadowPL","payoutSource",
